This is my website built using [Eleventy Excellent](https://github.com/madrilene/eleventy-excellent/tree/main). 

I've made modifications to suit my needs regarding the color setup. I left some of the original information below, but be sure to check out the original and the blog linked below.
